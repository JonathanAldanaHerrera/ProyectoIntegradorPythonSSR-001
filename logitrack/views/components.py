...
from logitrack.ui.theme import COLORES_ESTADO


class KPICard(ttk.Frame):

    def __init__(
        self, parent: tk.Widget, estado: str, icono: str, **kwargs: Any
    ) -> None:
        ...
        self.lbl_icono = ttk.Label(
            self, text=icono, font=("Segoe UI", 16), style="KPI.TLabel"
        )
...
class StatusBadge(ttk.Label):
    ...
    def __init__(self, parent: tk.Widget, estado: str, **kwargs: Any) -> None:
